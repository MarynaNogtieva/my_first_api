class NeighbourhoodsController < ApplicationController
  ...
  # GET /neighbourhoods
  # http://localhost:3000/neighbourhoods?max_home_price=400000
  # http://localhost:3000/neighbourhoods?max_home_price=400000&min_home_price=300000
  # http://localhost:3000/neighbourhoods?ranked_by=num_businesses

  # http://localhost:3000/neighbourhoods?ranked_by=num_businesses&max_home_price=400000
  def index
